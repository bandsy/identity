...
// const validateInput = (input: any, validation?: IInputValidation): string | number | boolean | null => {
//   if (input == null) {
//     return false;
//   }
...
//       break;
//     }
//     case IInputType.BOOLEAN: {
//       // NOTE: nested ternary is the cleanest and most conicise way to do this

//       // eslint-disable-next-line no-nested-ternary
//       const bool = input === "true" ? true : input === "false" ? false : null;

//       if (typeof bool === "boolean" || typeof input === "boolean") {
//         return bool ?? input;
//       }
